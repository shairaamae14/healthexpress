                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><img src="{{url('./dish_imgs/'.$pend->dish_img)}}"  style="width:30px; height:30px; float:left; margin-right: 10px" class="img-responsive img-rounded imagesize" alt="Responsive image">
                            ...
                            <td>{{$pend->order_date}}</td>
                            <td class="text-right"><span class="badge" style="color:white; background-color:#66bb6a; float:right">{{$pend->order_status}}</span></td>
                          </tr>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><img src="{{url('./dish_imgs/'.$cook->dish_img)}}"  style="width:30px; height:30px; float:left; margin-right: 10px" class="img-responsive img-rounded imagesize" alt="Responsive image">
                            ...
                            <td class="text-right"><span class="badge" style="color:white; background-color:#66bb6a; float:right">{{$cook->order_status}}</span></td>
                          </tr>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><img src="{{url('./dish_imgs/'.$del->dish_img)}}"  style="width:30px; height:30px; float:left; margin-right: 10px" class="img-responsive img-rounded imagesize" alt="Responsive image">
                            {{$del->dish_name}}<br>
                            {{$del->first_name}}&nbsp;{{$del->last_name}}</td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><img src="{{url('./dish_imgs/'.$com->dish_img)}}"  style="width:30px; height:30px; float:left; margin-right: 10px" class="img-responsive img-rounded imagesize" alt="Responsive image">
                            {{$com->dish_name}}<br>
                            {{$com->first_name}}&nbsp;{{$com->last_name}}</td>
                            <td>Php {{$com->totalAmount}}</td>
                            <td>{{$com->order_date}}</td>
                            <td class="text-right"><span class="badge" style="color:white; background-color:#66bb6a; float:right">{{$com->order_status}}</span>
                            </td>
                          </tr>
